...
class EarlyStopping:
    ...
    def __call__(self, val_loss, model, path, num_experiment,model_name,win_size,optimizer,lr,epoch):
        score = -val_loss
...
class Experiment(object):
    ...
    def __init__(self, config):
        ...
        if self.mode == "Train":
            ...
            self.vali_loader,_,_ = get_dataloader(data_path=self.data_path,batch_size=self.batch_size, win_size=self.win_size,mode = "Vali")
        else:
    ...
    def train(self):
        ...
        for epoch in range(self.num_epochs):
            ...
            print("Epoch: {0}, Steps: {1} | Train Loss: {3:.7f} | Vali Loss {3:.7f}".format(epoch + 1, train_steps,train_loss,vali_loss))

            early_stopping(vali_loss, self.model, path, self.num_Experiment,self.model_name,self.win_size,self.optimizer,self.lr,epoch)
