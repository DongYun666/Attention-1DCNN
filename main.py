...
if __name__ == '__main__':
    ...
    # parser.add_argument('--model_name', type=str, default="TransformerCNN1d",help="模型名称")
    # parser.add_argument('--model_name', type=str, default="CNN1D",help="模型名称")  
    # parser.add_argument('--model_name', type=str, default="CNN1d",help="模型名称")
    parser.add_argument('--model_name', type=str, default="DeepPacket",help="模型名称")    
    ...
    #使用Transformer的参数  
    parser.add_argument('--e_layers', type=int, default=1 ,help="encoder 的层数")
    ...
    parser.add_argument('--patience', type=int, default=100,help="早停机制中的patience参数") 
    ...
    parser.add_argument('--usepenalty', type=str,default='False',help="是否使用惩罚项")
    parser.add_argument('--gamma', type=int, default=2,help="惩罚项参数") 
    
    # 数据集部分
    parser.add_argument('--data_path',type=str,default='./processdata/TON_IOT_DeepPacket') #需要修改
    # 窗口内归一化
