            ...
            for packets in flows.values():
                ...
                for pkt in packets:
                    ...
                    if pkt.haslayer(IP):
                        ...
                        del packet[IPv6].nh
                    if packet.haslayer(TCP):
                        del packet[TCP].sport
                        del packet[TCP].dport
                    elif packet.haslayer(UDP):
                        del packet[UDP].sport
                        del packet[UDP].dport
                    if packet.haslayer(ARP):
                        del packet[ARP].psrc
                        del packet[ARP].pdst
...
if __name__ == "__main__":
    ...
    parser.add_argument('--dataset', type=str, default="TON_IOT",help="数据集名称")
